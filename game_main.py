...
class Cool():
    ...
    def main(self):
        ...
        cards_xy = [] * 6
        cards_xy.append(
            pygame.Rect(disp_card_spa * 3 + card_width * 2, disp_card_s_y, card_width, card_height))  # センターカード
        ...
        count_xy = pygame.Rect(card_width * 2 - pay_c_spa * 4, disp_card_s_y + card_height - pay_c_fontsize, card_width,
                               card_height)
        count_fra_xy = pygame.Rect(card_width * 2 - pay_c_spa * 4, disp_card_s_y + card_height - pay_c_fontsize,
                                   pay_c_fontsize * 1.6, pay_c_fontsize)

        # マーク部位表示
        pay_back_xy = pygame.Rect(
            [disp_card_spa * 4 + card_width * 3, pay_c_y, pay_c_spa * 15, pay_c_line * 4 - 10])  # 使用カード枠
